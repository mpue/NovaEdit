...
//		popupMenu.add(ctx.getBean(SetMoveModeCommand.class));
	...
	public void updateEditCommands() {
		...
		ctx.getBean(FlipHorizontalCommand.class).setEnabled(isSingleItemSelected && (selectedItem instanceof Symbol || selectedItem instanceof Part));
		ctx.getBean(FlipVerticalCommand.class).setEnabled(isSingleItemSelected && (selectedItem instanceof Symbol || selectedItem instanceof Part));
	}
