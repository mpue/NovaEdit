...
@XmlType(name = "Part", propOrder = { "imageName", "description", "packageType", "rotation", "author", "license","value","designator", "mirrorVertical","mirrorHorizontal","nameXOffset","nameYOffset","connections" })
public class Part extends Item implements Cloneable, Rotateable, Comparable<Item> {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		part.setMirrorHorizontal(isMirrorHorizontal());
		part.setMirrorVertical(isMirrorVertical());
