...
@XmlType(name = "Part", propOrder = {"xLoc", "yLoc", "index", "color", "layer","name","width","height","mirrorVertical","mirrorHorizontal", "filename", "rotation","value"})
public class PartBean {
	...
	public PartBean(Part part) {
		...
		value = part.getValue();
		layer = part.getLayer();
		mirrorHorizontal = part.isMirrorHorizontal();
		mirrorVertical = part.isMirrorVertical();
	}	
