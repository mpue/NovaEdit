 ...
 *
 */
public class NovaEdit extends AbstractApplication {

	public NovaEdit(String fileLocation) {
		super(fileLocation);
	}

	private static final Log log = LogFactory.getLog(NovaEdit.class);
	...
	public static void main(String[] args) throws Exception {
		...
		NovaEdit app = new NovaEdit(fileName);
