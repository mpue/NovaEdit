...
public class SetDrawRectangleModeCommand extends AbstractEditorCommand {

	private static final long serialVersionUID = 5549948184556011871L;
	
	public SetDrawRectangleModeCommand() {
		putValue(Action.NAME, resources.getResourceByKey("SetDrawRectangleModeCommand.name"));
		putValue(Action.SMALL_ICON,resources.getIcon("icon.rectangle"));
		putValue(Action.SHORT_DESCRIPTION, resources.getResourceByKey("SetDrawRectangleModeCommand.description"));
		putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.ALT_DOWN_MASK));
		setEnabled(false);
	}	
	...
	public void execute(ActionEvent e) {
		...
		editor.setEditorMode(EditorMode.DRAW_RECTANGLE);
