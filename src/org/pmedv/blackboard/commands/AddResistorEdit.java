 ...
 * 
 */
public class AddResistorEdit extends AbstractUndoableEdit {
	
	private static final long serialVersionUID = 268168440492800806L;
	private Resistor resistor;

	public AddResistorEdit(Resistor resistor) {
	...
	public void undo() throws CannotUndoException {
		...
		editor.getModel().getLayer(resistor.getLayer()).getItems().remove(resistor);
