...
import org.pmedv.blackboard.components.PartView;
...
public class ConvertToPartCommand extends AbstractEditorCommand {
	...
	public void execute(ActionEvent e) {
		...
		for (Item item : items) {
			...
			Rectangle bb = item.getBoundingBox();
		...
		AppContext.getContext().getBean(PartView.class).createIcon(newPart);
		AppContext.getContext().getBean(PartView.class).getModel().addPart(newPart);
