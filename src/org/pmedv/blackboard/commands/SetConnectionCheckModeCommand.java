...
public class SetConnectionCheckModeCommand extends AbstractEditorCommand {

	private static final long serialVersionUID = 5549948184556011871L;
	
	public SetConnectionCheckModeCommand() {
		putValue(Action.NAME, resources.getResourceByKey("SetConnectionCheckModeCommand.name"));
		putValue(Action.SMALL_ICON,resources.getIcon("icon.connection"));
		putValue(Action.SHORT_DESCRIPTION, resources.getResourceByKey("SetConnectionCheckModeCommand.description"));
		setEnabled(false);
	}	
	...
	public void execute(ActionEvent e) {
		...
		editor.setEditorMode(EditorMode.CHECK_CONNECTIONS);
