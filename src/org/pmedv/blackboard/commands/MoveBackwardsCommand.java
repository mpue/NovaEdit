...
public class MoveBackwardsCommand extends AbstractCommand {

	private static final long serialVersionUID = -652122685358514590L;
	
	public MoveBackwardsCommand() {
		putValue(Action.NAME, resources.getResourceByKey("MoveBackwardsCommand.name"));
		putValue(Action.SMALL_ICON,resources.getIcon("icon.movebackwards"));
		putValue(Action.SHORT_DESCRIPTION, resources.getResourceByKey("MoveBackwardsCommand.description"));	
	...
	public void execute(ActionEvent e) {
		...
		// find the index of the previous part		
		int index = 0;
		Item swapItem = null;
