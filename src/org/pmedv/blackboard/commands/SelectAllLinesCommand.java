 ...
 *
 */
public class SelectAllLinesCommand extends AbstractEditorCommand {

	private static final long serialVersionUID = -1204971682381964487L;
	
	public SelectAllLinesCommand() {
		putValue(Action.NAME, resources.getResourceByKey("SelectAllLinesCommand.name"));		
		putValue(Action.SHORT_DESCRIPTION, resources.getResourceByKey("SelectAllLinesCommand.description"));
		putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_A, InputEvent.CTRL_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK));
		setEnabled(false);
	}
