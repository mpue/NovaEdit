...
public class SetMoveModeCommand extends AbstractEditorCommand {

	private static final long serialVersionUID = 5549948184556011871L;
	
	public SetMoveModeCommand() {
		putValue(Action.NAME, resources.getResourceByKey("SetMoveModeCommand.name"));
		putValue(Action.SMALL_ICON,resources.getIcon("icon.move"));
		putValue(Action.SHORT_DESCRIPTION, resources.getResourceByKey("SetMoveModeCommand.description"));
	...
	public void execute(ActionEvent e) {
		...
		editor.setEditorMode(EditorMode.MOVE);
