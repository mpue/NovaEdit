		...
		DropTarget dt = new DropTarget(editor, new DropTargetAdapter() {
			...
			public void drop(DropTargetDropEvent e) {
				...
				try {
					...
					Object data = e.getTransferable().getTransferData(flavors[0]);
					
					if (data instanceof SymbolBean) {
						symbol = (SymbolBean)data;						
					...
					else if (data instanceof Part) {
						part = (Part)data;		
						part = (Part)part.clone();
						editor.getModel().getCurrentLayer().getItems().add(part);
